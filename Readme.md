...
![image](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2P0hXdbSCpRW_xtz4GeTpdowmBKxPYbVUqA&usqp=CAU)
...
* [_link to the image shown above_](https://media.geeksforgeeks.org/wp-content/uploads/introduction-to-firewall-1.png)
...
### **Packet Filtering Firewall**
 ...
 >_A Data packet is a bit of data that is packaged for transmission over a packet-switched network. It is a small amount of data sent over a network, such as a LAN or the Internet._
...
> Here are few [more](github) references to learn more about firewalls:
